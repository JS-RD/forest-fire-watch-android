...
class BottomSheetLayout : FrameLayout {
    ...
    private var fireImageView = findViewById<ImageView>(R.id.bottomsheert_switch_fire)

    private var cloudImageView = findViewById<ImageView>(R.id.bottomsheet_switch_cloud)
